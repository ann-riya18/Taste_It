...
// =========================================================
// 1. Setup & Session Key (Dedicated to WHAT TO COOK)
// =========================================================
...
function cleanse_ingredient_line($line) {
    ...
    $patterns = [
        '/\b\d+(\s*\/\s*\d+)?(\-\s*\d+)?\b/', 
        '/\b(cups?|teaspoons?|tbsps?|ounces?|oz|grams?|g|pounds?|lbs?|ml|liters?|pinches?|dashes?|sprigs?|clo(ves?)|can(s?)|pkg|slices?|jars?|bottles?)\b/',
        '/\b(crushed|chopped|melted|diced|finely|fresh|dried|small|large|medium|sweet|ground|whole|peeled|grated|sliced|cubed|minced|toasted|warm|cold|softened|cooked|uncooked|plain|shredded|packed|loosely|optional|boneless|skinless|reduced|low|zest|kosher|sea|flaky|table|black)\b/', 
        '/(^of\s|\swith\s|\sfor\s|\sand\s|\sfrom\s|\s|\(|\)|\-|\/|\\|:|\.)/',
        '/\bwater\b/', 
    ];
